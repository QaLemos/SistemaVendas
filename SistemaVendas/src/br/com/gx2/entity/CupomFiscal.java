...
public class CupomFiscal implements Serializable{
	...
	public CupomFiscal(Integer codigoCupom, Double valorTotal, Date emissao, Loja loja, Cliente cliente,
			Vendedor vendedor, ItemCupomFiscal itemCupomFiscal) {
		super();
	...
	public String toString() {
		return "CupomFiscal [codigoCupom=" + codigoCupom + ", valorTotal=" + valorTotal + ", emissao=" + emissao
				+ ", loja=" + loja + ", cliente=" + cliente + ", vendedor=" + vendedor + ", itemCupomFiscal="
				+ itemCupomFiscal + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((itemCupomFiscal == null) ? 0 : itemCupomFiscal.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (emissao == null) {
			...
			return false;
		if (itemCupomFiscal == null) {
			if (other.itemCupomFiscal != null)
				return false;
		} else if (!itemCupomFiscal.equals(other.itemCupomFiscal))
			return false;
		if (loja == null) {
			if (other.loja != null)
				return false;
	...
	public void setItemCupomFiscal(ItemCupomFiscal lista) {
		this.itemCupomFiscal = lista;
	}
