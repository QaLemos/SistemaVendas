...
import br.com.gx2.dao.imp.ItemCupomFiscalDAOImp;
...
public class DAOFactory {
	...
	public static ItemCupomFiscalDAO createItemCupomFiscalDAO() {

		return new ItemCupomFiscalDAOImp(ConnectionFactory.getConnection());
	}
